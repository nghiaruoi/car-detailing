...
const PackageSection = ({
	...
	<div className="bg-white p-6 rounded-xl shadow-xl">
		...
		<DynamicTwoColumnDescriptionSection {...paragraphDataTwo} />
		<DynamicTwoColumnDescriptionSection {...paragraphDataThree} />
		{/* <DynamicTwoColumnDescriptionSection {...paragraphDataFour} /> */}
		<DynamicTwoColumnDescriptionSection {...paragraphDataFive} />
		{/* Schedule Now Button */}
...
const paragraphData = {
	leftSection: {
		title: 'Porsche Shampoo and Convertible Top Cleaner - White Edition',
		paragraph:"",
		image: '/images/porsche-shampoo.jpeg',
	},
	rightSection: {
		title: 'The Porsche Sponge ',
		paragraph: "The Porsche Sponge is a versatile, finely pored sponge for gentle hand-washing and keeps your Porsche looking at its best at all times.",
		image: '/images/premiumleathercare.png',
	},
};
const paragraphDataTwo = {
	leftSection: {
		title: '',
		paragraph:"",
		image: '/images/IMG_3606.jpeg',
	},
	rightSection: {
		title: '',
		paragraph: "",
...
const paragraphDataThree = {
	leftSection: {
		title: '',
		paragraph:"",
		image: '/images/IMG_3607.jpeg',
	},
	rightSection: {
		title: '',
		paragraph: "",
		image: '/images/IMG_3590.jpeg',
	},
};
const paragraphDataFour = {
	leftSection: {
		title: '',
		paragraph:"",
		image: '/images/IMG_3609.jpeg',
	},
	rightSection: {
		title: '',
		paragraph: "",
		image: '/images/Image.heic',
	},
};
const paragraphDataFive = {
	leftSection: {
		title: '',
		paragraph:"",
		image: '/images/IMG_3610.jpeg',
	},
	rightSection: {
		title: '',
		paragraph: "",
		image: '/images/IMG_3631.jpeg',
	},
};
...
const sectionWash = {
	...
	leftSection: {
		items: [
			'Gently hand wash with  Porsche Shampoo and Convertible Top Cleaner - White Edition , Clean wheels & tires',
			'Wash with Clay pad for Perfect cleaning and unmatched deep shine',
	...
	rightSection: {
		...
		items: [
			'Removing water from all air vents, radiator grilles, mirrors or hidden places in cars.',
			'Tire Glaze is a premium, high-gloss tire dressing.',
		],
	},
};
...
const sectionInterior = {
	...
	leftSection: {
		items: [
			...
			'Seats, Plastics, Consoles, Interior trim, Floor & Floor mats, Ceiling, Trunk, Windows, Care for Leather.',
